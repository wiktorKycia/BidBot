...
ORDER_TYPE_DICT = {
    "Dostawa": "Dostawy",  # na platformie zakupowej rodzaj "Dostawy" jest już w liczbie mnogiej, więc wg. mnie można zakomentować, żeby nie rzucało warningów niepotrzebnie
    "Usługa": "Usługi",
