...
class GroupedTagsOutput(BaseModel):
	industries: dict[str, dict[str, int]] = Field(
		description="Mapping from industry name to exact original tag names with their counts."
	)
...
SYSTEM_PROMPT = SystemMessage(
	content=(
		...
		"Use human-readable industry names such as IT, budownictwo, transport, administracja, edukacja, medycyna, energetyka, usługi, rolnictwo, finanse, inżynieria, and Inne when needed. "
